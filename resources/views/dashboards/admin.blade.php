...
<x-layout title="Admin Dashboard">
    <div class="max-w-6xl mx-auto py-10">
        <h1 class="text-3xl font-bold text-indigo-700 mb-8 text-center">Admin Dashboard</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-10">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
                ...
                <div class="text-2xl font-bold text-indigo-700">{{ $usersCount ?? 0 }}</div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
                ...
                <div class="text-gray-600">Requests</div>
            </div>
            <!-- Donation Posts -->
            <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
                <div class="bg-purple-100 p-4 rounded-full mb-3 animate-bounce">
                    <i class="fa-solid fa-gift text-3xl text-purple-600"></i>
                </div>
                <div class="text-2xl font-bold text-purple-700">{{ $donationPostsCount ?? 0 }}</div>
                <div class="text-gray-600">Donation Posts</div>
            </div>
            <!-- My Clothes -->
            <div class="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center hover:scale-105 transition-transform duration-300">
        ...
        <div class="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
                <h2 class="text-2xl font-bold text-indigo-700 mb-2">Welcome, {{ Auth::user()->name }}!</h2>
                <p class="text-gray-700 mb-4">
                    Here you can manage users, requests, donation posts, and monitor all platform activities as an admin.
                </p>
                <a href="{{ route('admin.donations') }}" class="inline-block bg-indigo-600 text-white px-6 py-2 rounded-lg shadow hover:bg-indigo-700 transition">View Donations</a>
            </div>
            <div>
                <img src="https://lottie.host/9b1e7b7d-6e2b-4c3e-8b2a-9e2e7b7d6e2b/animation.gif" alt="Admin Animation" class="w-48 h-48 object-contain animate-pulse">
            </div>
        </div>
    </div>
