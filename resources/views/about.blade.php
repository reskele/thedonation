...
<x-layout title="About Us">
    <section class="bg-gradient-to-br from-indigo-50 to-white min-h-screen flex items-center justify-center py-12">
        <div class="max-w-2xl w-full bg-white rounded-xl shadow-lg p-8">
            <h1 class="text-4xl font-extrabold text-indigo-700 mb-4 text-center">About Our Platform</h1>
            <p class="text-lg text-gray-700 mb-6 text-center">
                Welcome to <span class="font-semibold text-indigo-600">{{ config('app.name', 'clothShare') }}</span>!<br>
            ...
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-indigo-600 mb-2">How It Works</h2>
            ...
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-indigo-600 mb-2">Why Choose Us?</h2>
                <ul class="list-disc list-inside text-gray-600 space-y-1">
            ...
            <div class="text-center mt-8">
                <a href="{{ route('home') }}" class="inline-block bg-indigo-600 text-white px-6 py-2 rounded-lg shadow hover:bg-indigo-700 transition">
                    Back to Home
                </a>
            </div>
        </div>
